package com.ifsp.instalamento.estrutura.persistencia;
...
public class ConexaoBancoDados {
	...
	private EntityManagerFactory getCriarFabricaConexao() {
		...
		properties.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/instalamento?createDatabaseIfNotExist=true&useSSL=false");
		...
		properties.put("hibernate.default_schema", "instalamento");
